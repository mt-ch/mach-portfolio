...
export function ProjectHeader({ project }: { project: ProjectDetail }) {
  ...
  return (
    <header className="p-md relative min-h-124 grid lg:grid-cols-2 w-full bg-white text-black">
      <div className="flex flex-col col-start-2 justify-between gap-2xl">
        <h2 className="type-body font-medium">(Work)</h2>
        <div className="flex flex-col gap-2xl">
          <div className="flex flex-col gap-md">
            ...
            {project.role && (
              <div>
                <p className="type-body font-medium text-grey-300">{project.role}</p>
              </div>
            )}
          </div>
