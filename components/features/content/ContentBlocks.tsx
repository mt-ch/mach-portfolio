...
function BlockImage({ image, layout }: { image: ImageBlock["image"] | ImageBlock["secondImage"]; layout: Layout }) {
...
export function ContentBlocks({ blocks }: { blocks: ContentBlockList | null | undefined }) {
